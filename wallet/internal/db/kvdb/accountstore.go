...
var (
	// errMissingAddrmgrNamespace is returned when the legacy address manager
	// bucket is not available in the kvdb wallet database.
	errMissingAddrmgrNamespace = errors.New("missing waddrmgr namespace")

	// errMissingLegacyAddrStore is returned when the kvdb adapter needs the
	// legacy address manager but was constructed without it.
